...
if (!createObject('modNamespace',array(
    'name' => 'commerce_packingslip',
    'path' => $componentPath.'/core/components/commerce_packingslip/',
    'assets_path' => $componentPath.'/assets/components/commerce_packingslip/',
),'name', false)) {
    echo "Error creating namespace commerce_packingslip.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_packingslip.core_path',
    'value' => $componentPath.'/core/components/commerce_packingslip/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_packingslip',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_packingslip.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_packingslip.assets_path',
    'value' => $componentPath.'/assets/components/commerce_packingslip/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_packingslip',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_packingslip.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_packingslip/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_packingslip.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_packingslip',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_packingslip.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        ...
        echo "Error creating commerce_packingslip.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_packingslip/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_packingslip/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'modmore\\Commerce\\PackingSlip\\Modules\\', $modulePath);
